...
class TestShortChainEstimation:
    ...
    def test_diagnostics_complete(self, estimation_result: EstimationResult) -> None:
        ...
        assert d.r_hat.shape == (30,)
        assert d.ess.shape == (30,)
        assert d.geweke_z.shape == (30,)
        assert d.geweke_p.shape == (30,)
        assert len(d.parameter_names) == 30
